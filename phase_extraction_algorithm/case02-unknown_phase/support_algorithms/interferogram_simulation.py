...
'''
        Test phases. Each phase is genererated using different mathematical formula.
        These tests are used to evaluate the stability and automation of the 
        software.
'''
...
def phi2(x, y, factors):
        return factors[0] * (x**2. + y**2. + x*y) + factors[1] * sin(factors[2] * x + factors[2] * y)


'''
        Set up the interferogram using the test phase
'''
